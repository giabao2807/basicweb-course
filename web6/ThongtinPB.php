...
<body>
    ...
    //in Tieu de cua bang
    echo '<TR><TH>IDPB</TH><TH>Ten PB</TH><TH>Mota</TH><TH>DSNV</TH></TR>';
    while($row=mysqli_fetch_array($rs)){
        echo '<Tr><TD>'.$row["IDPB"].'</TD><TD>'.$row["TenPB"].'</TD><TD>'.$row["Mota"].'</TD><TD> <a href="ThongtinNVPB.php?IDPB='.$row["IDPB"]
